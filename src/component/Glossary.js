    ...
    <section className="general-main-content">
      ...
      <section id="glossary">
        ...
        <div className="glossary-term">
          ...
          <p>
            Knit two stitches together as though they were a single stitch. This
            makes a right leaning decrease.
          </p>
        </div>
        <div className="glossary-term">
          <h3>
          ...
          <p>
            Slip slip knit. Slip two stitches as if to knit. Insert left needle
            through the front loops of the slipped stitches then knit them
            together. This makes a left leaning decrease.
          </p>
        </div>
        <div className="glossary-term">
          <h3>

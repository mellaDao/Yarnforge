        ...
        <div className="stitches-tutorial">
          ...
          <div className="video-container">
            <div id="tutorial-video-co" className="tabcontent active">
              ...
              <p>
                The long tail cast on is a popular method used to begin knitting
                projects. It creates a neat, stretchy edge and is relatively
                easy to learn. A text explanation can be confusing to read,
                therefore, please watch this knitting tutorial to understand
                this cast on. Also, a good tip for this cast on is to remember
                that when leaving a tail of yarn (the "long tail"), the length
                should be approximately three times the width of your project.
                It is better to overestimate the length of the long tail.
              </p>
            </div>
            ...
            <div id="tutorial-video-k" className="tabcontent">
              ...
              <p>
                ...
                learn. To create a knit stitch, continental knitters will first
                make sure the yarn is in the back of the work. Then, the right
                needle is inserted into the front loop of the stitch then the
                yarn is "picked" up and pulled in through the loop.
              </p>
            </div>
            ...
            <div id="tutorial-video-inc" className="tabcontent">
              ...
              <p>
                ...
                and place it on the left needle, then knit into the back loop of
                the lifted bar.
              </p>
              ...
              <p>Credit: @KnittingHelp.com on YouTube</p>
              <p>
                This type of increase creates a hole in the knitted work. It is
                essential to learn for lace patterns. When performing a yarn
                over, the yarn needs to be brought to the front between the
                needles then without knitting into the next stitch, simply wrap
                the working yarn over the right-hand needle towards the back.
              </p>
            </div>
            ...
            <div id="tutorial-video-dec" className="tabcontent">
              ...
              <p>
                ...
                slip two stitches as if to knit then insert left needle through
                the front loops of the slipped stitches then knit them together
                through the back loops. An improved version of SSK will slip one
                stitch as if to knit, then slip the next as if to purl, then
                knit them together through the back loops. This version lays
                slightly flatter and looks more similar to k2tog so some may
                prefer this method.
              </p>
            </div>
            ...
            <div id="tutorial-video-bo" className="tabcontent">
              ...
              <p>
                ...
                then pass it over the second. A pattern may call to bind off in
                pattern which means to continue working in pattern and for every
                two stitches worked, pass the first stitch over the second. For
                example, to bind off in pattern for 1x1 rib, you may knit one
                stitch, purl the next, then pass the knit stitch over the purl
                stitch.
              </p>
            </div>
          </div>
